...
namespace Editor.Lesson8_EditorGUILayout_开关_开关组
{
    public class Lesson8 : EditorWindow
    {
        [MenuItem("UnityEditorExtension/Lesson8/OpenWindow")]
        public static void ShowWindow()
        {
            var window = GetWindow<Lesson8>();
        ...
        private void OnGUI()
        {
            EditorGUILayout.LabelField("Lesson8", "Test Content", EditorStyles.boldLabel);
