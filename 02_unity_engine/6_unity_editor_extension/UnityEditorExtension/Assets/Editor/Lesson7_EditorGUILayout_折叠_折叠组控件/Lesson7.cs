...
namespace Editor.Lesson7_EditorGUILayout_折叠_折叠组控件
{
    public class Lesson7 : EditorWindow
    {
        [MenuItem("UnityEditorExtension/Lesson7/OpenWindow")]
        public static void ShowWindow()
        {
            var window = GetWindow<Lesson7>();
        ...
        private void OnGUI()
        {
            EditorGUILayout.LabelField("Lesson7", "Test Content", EditorStyles.boldLabel);
