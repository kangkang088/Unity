...
namespace Editor.Lesson6_EditorGUILayout_对象关联_各类型输入控件
{
    public class Lesson6 : EditorWindow
    {
        [MenuItem("UnityEditorExtension/Lesson6/OpenWindow")]
        public static void ShowWindow()
        {
            var window = GetWindow<Lesson6>();
        ...
        private void OnGUI()
        {
            EditorGUILayout.LabelField("Lesson6", "Test Content", EditorStyles.boldLabel);
